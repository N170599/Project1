...
function store(){
    ...
    $expiry = $_POST['expiry'];
    $status = $_POST['status'];
    $sql = "INSERT INTO product (prd_name,cat_id,image,weight,price,uses,recommended_use,expiry,status)
            VALUES ('$prd_name','$cat_id',' $image','$weight',$price,'$uses',' $recommended_use',$expiry,$status)";
